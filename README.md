...
- Client `.js` được gắn version riêng theo dạng `version-chính.N`; trong cùng version chính, `N` tăng theo số lần nội dung file đổi, còn khi version chính đổi thì `N` reset về `1`
