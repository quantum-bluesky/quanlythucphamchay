...
- Từ màn `Đơn hàng`, có thể bấm `Xuất lại` trên đơn đã `Đã xuất hàng` hoặc `Đã thanh toán` để tạo nhanh một đơn nháp mới với cùng khách, địa chỉ giao, giảm giá và các dòng hàng
