...
export const SCREEN_HELP = {
  ...
  purchases: {
    ...
    steps: [
      ...
      "Sau khi phiếu đã `Nhập kho` nhưng chưa `Đã thanh toán`, bạn vẫn được sửa riêng `Giảm giá khuyến mại`; app không mở khóa lại nhà cung cấp hay các dòng nhập đã nhận.",
