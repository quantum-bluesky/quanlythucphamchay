...
export const SCREEN_HELP = {
  ...
  purchases: {
    ...
    steps: [
      ...
      "Phiếu đã nhập kho, đã thanh toán hoặc đã hủy sẽ chuyển sang chế độ chỉ xem; nếu sai sót thì mở `Detail` của đúng phiếu cũ rồi bấm `Trả NCC`; app không còn hiện form trả NCC độc lập ngoài list để tránh nhầm thao tác.",
