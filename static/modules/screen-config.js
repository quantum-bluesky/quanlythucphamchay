...
export const SCREEN_HELP = {
  ...
  "create-order": {
    ...
    steps: [
      ...
      "Sau khi đơn đã chốt nhưng chưa đánh dấu `Đã thanh toán`, bạn vẫn được sửa riêng `Giảm giá khuyến mại`; các dòng hàng và tồn kho vẫn tiếp tục bị khóa như cũ.",
      "Nếu thiếu hàng, app sẽ báo trước khi tạo hoặc cập nhật phiếu nhập tương ứng; nếu đã có phiếu chờ nhập đủ số lượng thì app chỉ thông báo và mở lại phiếu đó khi bạn xác nhận cần chỉnh.",
      DESKTOP_PAGINATION_HINT,
      DESKTOP_MENU_HINT,
      MOBILE_FLOATING_HINT,
    ],
  ...
  orders: {
    ...
    steps: [
      ...
      "Ngoại lệ duy nhất trước khi thanh toán là bạn vẫn có thể sửa `Giảm giá khuyến mại` của toàn đơn; app sẽ cập nhật lại số tiền cần thu nhưng không mở khóa số lượng, giá bán hay tồn kho.",
