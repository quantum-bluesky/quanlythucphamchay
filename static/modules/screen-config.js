...
export const SCREEN_HELP = {
  ...
  "create-order": {
    ...
    steps: [
      ...
      "Trong Giỏ hiện hành, mỗi dòng đã chọn hiển thị dưới dạng card gọn 2 dòng; bấm `...` để mở detail rồi đổi đơn vị tính (cơ sở / quy đổi), số lượng, giá bán cho riêng đơn này. Đổi đơn vị qua lại giữ nguyên lượng hàng cơ sở, kể cả khi số hiển thị làm tròn; sửa số lượng sẽ tính lại lượng hàng theo đơn vị đang chọn. Các dòng nằm trước nút Chốt/Xuất/Hủy. Bấm Lưu dòng để chỉ cập nhật dòng của đơn đang mở và giữ đơn vị sau khi tải lại; nếu có xung đột, tải lại đơn rồi kiểm tra trước khi lưu lại. App tự điền đơn giá theo đơn vị được chọn.",
