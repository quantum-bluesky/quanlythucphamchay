...
export const SCREEN_HELP = {
  ...
  "create-order": {
    ...
    steps: [
      ...
      "Trong Giỏ hiện hành, mỗi dòng đã chọn hiển thị dưới dạng card gọn 2 dòng; bấm `...` để mở detail rồi đổi đơn vị tính (cơ sở / quy đổi), số lượng, giá bán cho riêng đơn này. Khi đổi đơn vị, app tự động tính lại số lượng để bảo toàn lượng hàng cơ sở và tự điền đơn giá theo đơn vị đó.",
