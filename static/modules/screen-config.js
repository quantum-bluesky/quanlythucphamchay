...
export const SCREEN_HELP = {
  ...
  "procurement-planner": {
    ...
    steps: [
      ...
      "Nếu owner rời `Xử lý nhập thiếu` sang màn ngoài flow batch khi kỳ gom vẫn còn mở, app sẽ hỏi có muốn `Kết thúc kỳ gom` ngay không; `OK` thì release lock rồi mới rời màn, `Cancel` thì giữ nguyên batch mode.",
