...
export const SCREEN_HELP = {
  ...
  "create-order": {
    ...
    steps: [
      ...
      "Ghi chú phiếu xuất là field cấp toàn phiếu: có thể nhập ngay cạnh ô khách hàng, xem lại trong `Detail`, và còn sửa được tới trước khi đơn đã `Đã thanh toán`.",
  ...
  orders: {
    ...
    steps: [
      ...
      "Trong `Detail`, ghi chú phiếu xuất luôn hiện như metadata của phiếu; trước `Đã thanh toán` vẫn có thể sửa trực tiếp ghi chú này mà không ảnh hưởng tồn kho hay trạng thái.",
      ...
      "Đơn `Đã xuất hàng` không còn cho sửa trực tiếp mặt hàng, số lượng, địa chỉ giao hay giá; trước thanh toán chỉ còn được sửa `Giảm giá khuyến mại` và `ghi chú` của toàn đơn.",
  ...
  purchases: {
    ...
    steps: [
      ...
      "Sau khi phiếu đã `Nhập kho` nhưng chưa `Đã thanh toán`, bạn vẫn được sửa `Ghi chú`, `Giảm giá khuyến mại` và cập nhật lại cách nhập HSD / ngày sản xuất của từng dòng; app không mở khóa lại số lượng, giá, mã lô, nhà cung cấp hay cấu trúc dòng nhập.",
