...
export const SCREEN_HELP = {
  ...
  purchases: {
    ...
    steps: [
      ...
      "Khi Batch mode đang bật, chỉ người giữ khóa batch hoặc Master Admin mới được tạo mới, sửa cấu trúc, đổi NCC, đổi giảm giá, hủy hoặc xóa phiếu `Nháp/Đã đặt`; user khác vẫn có thể tiếp tục bước `Nhập kho` hoặc `Đã thanh toán` nếu quy trình cần tách người xử lý hậu cần.",
