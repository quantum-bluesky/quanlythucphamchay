...
export const SCREEN_HELP = {
  ...
  "procurement-planner": {
    ...
    steps: [
      ...
      "Khối extra sẽ ưu tiên nhóm các sản phẩm đã có trên planner nhưng `Cần nhập = 0`, sau đó mới hiện toàn bộ sản phẩm active còn lại ngoài planner; tick dòng nào thì dòng đó mới bung ô nhập nhanh.",
