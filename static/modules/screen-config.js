...
export const SCREEN_HELP = {
  ...
  orders: {
    ...
    steps: [
      ...
      "Trước khi `Xuất`, `Đã thanh toán` hoặc `Hủy`, app sẽ hiện message confirm để bạn kiểm tra lại thao tác đổi trạng thái.",
  ...
  purchases: {
    ...
    steps: [
      ...
      "Trước khi `Đã đặt hàng`, `Nhập kho`, `Đã thanh toán` hoặc `Hủy phiếu`, app sẽ hiện message confirm để bạn kiểm tra lại trạng thái sắp chuyển.",
