...
| 28 | `IT-LOG-04` | Kiểm tra màn login mặc định điền `masteradmin`, dropdown `Tài khoản nhanh` điền nhanh Biz Manager, và dropdown `Chuyển user...` cạnh Logout phải logout phiên hiện tại, điền username mới nhưng vẫn bắt nhập lại password trước khi đổi quyền. |
