...
- `Version cache-busting client JS`: HTML entrypoint và các module import phải được serve kèm query `?v=version-chính.N`, đồng thời counter phải tăng đúng khi file `.js` đổi nội dung
